...
export const architectureConfig = [
  {
    ...
    settings: {
      ...
      'boundaries/elements': [
        ...
        { type: 'catalog_components', pattern: 'src/model/news/components/**', mode: 'full' },
      ...
      'boundaries/dependencies': [
        'error',
        {
          ...
          rules: [
            ...
            {
              from: { type: ['catalog_components', 'model'] },
              allow: allowTypes(['catalog_components', 'model', ...SHARED_AND_CORE]),
              disallow: allowTypes(['pages_auth', 'app', 'pages', 'catalog_pages', 'features']),
            },
            {
              from: { type: 'features' },
              allow: allowTypes(['features', 'model', 'catalog_components', ...SHARED_AND_CORE]),
