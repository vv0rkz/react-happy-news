...
const SHARED = ['shared_components', 'shared_lib', 'shared_config']
...
export const architectureConfig = [
  {
    ...
    settings: {
      ...
      'boundaries/elements': [
        ...
        { type: 'shared_components', pattern: 'src/shared/components/**', mode: 'full' },
        { type: 'catalog_components', pattern: 'src/entities/news/components/**', mode: 'full' },
      ...
      'boundaries/dependencies': [
        'error',
        {
          ...
          rules: [
            ...
            {
              from: { type: ['catalog_components', 'entities'] },
              allow: allowTypes(['catalog_components', 'entities', ...SHARED_AND_CORE]),
              disallow: allowTypes(['pages_auth', 'app', 'pages', 'catalog_pages', 'features']),
            },
            {
              from: { type: 'features' },
              allow: allowTypes(['features', 'entities', 'catalog_components', ...SHARED_AND_CORE]),
            ...
            },
            {
              ...
              allow: allowTypes(['pages_auth', 'pages', ...SHARED_AND_CORE, 'entities', 'catalog_components']),
