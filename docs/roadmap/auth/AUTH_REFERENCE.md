...
> Читай **один раз** при старте auth-трека v2.2. Рабочий план — [CURRENT_INCREMENT.md](../CURRENT_INCREMENT.md); трекер под-шагов — [CURRENT_RELEASE.md](../CURRENT_RELEASE.md) (#1–#6).
> Полная **Практика** и **Проверка и тесты** — [ROADMAP.md](../ROADMAP.md) § US 2.2.1–2.2.10. Архив mega: [_archive/MEGA_AUTH_v1.md](./_archive/MEGA_AUTH_v1.md).
...
| 7 | **D** + **A** | `oauthService`, `GoogleButton` | Google OAuth login | → **US 2.2.10** |
