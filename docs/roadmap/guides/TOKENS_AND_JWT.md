...
Client-файлы — [CURRENT_RELEASE.md](../CURRENT_RELEASE.md) § Инкремент #2 (Client Session).
...
- [CURRENT_RELEASE.md](../CURRENT_RELEASE.md) — US 2.2.1 Backend + Client Session (полная Практика)
